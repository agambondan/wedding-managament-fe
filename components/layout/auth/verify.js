    ...
    return (
        <section className="bg-gray-50 dark:bg-gray-900">
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <a target={"_blank"} href="/assets/images/UndanganOnline-2.png" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                    <img className="w-24 h-24 rounded-full shadow-lg align-middle" src="/assets/images/UndanganOnline-2.png"
                         alt="logo"/>
                </a>
                <div
