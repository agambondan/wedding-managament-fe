	...
	return (
		<section className='bg-gray-50 dark:bg-gray-900'>
			<div className='flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0'>
				<a
					target={'_blank'}
					href='/assets/images/UndanganOnline-2.png'
					className='flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white'
				>
					<img
						className='w-24 h-24 rounded-full shadow-lg align-middle'
				...
				<div className='w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8'>
					...
					>
						<div>
							...
							<p
								className={`${
									isPasswordSame ? 'block' : 'hidden'
								} text-xs text-red-600`}
							>
								Password not equals with Confirm Password
							</p>
						</div>
						<div>
							<label
							...
							<div className={'relative mb-2'}>
								...
								<div className='absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5'>
									...
									>
										<svg
											className={`h-6 text-gray-700 ${show1 ? 'hidden' : 'block'}`}
											fill='none'
											xmlns='http://www.w3.org/2000/svg'
											viewBox='0 0 576 512'
										>
									...
									>
										<svg
											className={`h-6 text-gray-700 ${show1 ? 'block' : 'hidden'}`}
											fill='none'
											xmlns='http://www.w3.org/2000/svg'
											viewBox='0 0 640 512'
										>
							...
							>
								Confirm Password not equals with Password
							</p>
						</div>
