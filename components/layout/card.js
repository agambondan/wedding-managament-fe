			...
			<div className='rounded-lg shadow-lg bg-white max-w-sm'>
				...
				<div className='p-6'>
					...
					<p className='text-gray-700 text-base mb-4'>
						Congratulations, your account has been successfully created. automatically
...
export function CardProfileHalfWidth(props) {
	return (
		<div className='xl:w-1/2'>
			<h2 className={'pb-3 text-4xl uppercase'}>{props.title}</h2>
			<div className={'flex'}>
				<div className='max-w-sm w-full lg:max-w-full lg:flex'>
					<img
						src={
							'https://media.istockphoto.com/id/1174403060/id/foto/pria-berjas-mengoreksi-dasi-kupu-kupunya-persiapan-pagi-pengantin-pria-di-rumah-foto-fashion.jpg?b=1&s=612x612&w=0&k=20&c=J5sMoGgePkeQzWs7tYrSoBmLNSpnX1rywM4JBmvZOoU='
						}
						className='h-96 lg:h-auto lg:w-96 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden'
						title={`${props.title} Photo`}
					></img>
					<div className='border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal'>
						<div className='mb-8'>
							...
							<div className='text-gray-900 font-bold text-xl mb-2'>Gender : Man</div>
							<div className='text-gray-900 font-bold text-xl mb-2'>
								Nickname : Agam
							</div>
							<div className='text-gray-900 font-bold text-xl mb-2'>
								Parents Name : Royani & Setia Kasih
							</div>
						</div>
...
export function CardUserProfile(props) {
	return (
		<div className='flex flex-wrap justify-center items-center'>
			<div className='container max-w-lg bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out 2xl:m-10 xl:m-8 lg:m-6 m-2'>
				...
				<div className='flex'>
					<div className='px-7 mb-8'>
						...
						<p className='mt-2 text-gray-600 dark:text-gray-300'>
							...
							molestiae vitae odio non commodi itaque quisquam incidunt doloribus fugit
							nesciunt.
						</p>
						<button
							className={
								'flex flex-wrap justify-center gap-2 sm:gap-4 mt-8 px-4 py-2 cursor-pointer bg-green-900 max-w-xs ' +
								'text-center mx-auto mt-8 rounded-lg text-gray-300 hover:bg-green-800 hover:text-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-gray-200 uppercase'
							}
							onClick={() => {
								props.setClick(!props.click);
							}}
