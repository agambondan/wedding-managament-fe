...
export default function Login(props) {
    ...
    const handleLogin = async (event) => {
        ...
        Swal.showLoading()
        await axios.post(`${process.env.IP}/api/v1/auth/login`, {
            "login": username, "email": username, "password": password, "remember_me": rememberMe
        }, {
        ...
        <Authorization.Provider value={authorization}>
            <section className="h-screen">
                <div className="px-6 h-full text-gray-800">
                    <div
                        className="flex flex-wrap justify-center lg:justify-between xl:justify-center items-center h-full gap-6">
