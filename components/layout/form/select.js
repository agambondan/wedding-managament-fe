...
export function Select(props) {
	...
	const title = (props.title.match(/[a-zA-Z0-9]+/g) || [])
	...
	return (
		<div className={'py-1'}>
			<label
				htmlFor='select'
				className='block uppercase tracking-wide text-gray-700 font-bold block my-2 dark:text-gray-400'
			>
				{title}
			</label>
			<select
				id='select'
				value={props.inputFields[props.title + '_id']}
				className='px-3 py-3 my-1 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm border
