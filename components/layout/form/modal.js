			...
			<div className='justify-center items-center flex overflow-x-auto overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none'>
				<div className='relative w-auto my-6 mx-auto max-w-3xl'>
					...
					<div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
						{/*header*/}
						<div className='flex px-32 py-2 border-b border-solid border-slate-200 rounded-t'>
							<h3 className='justify-start text-3xl font-semibold'>{props.title}</h3>
							<button
						...
						<div className='relative px-2 py-2 flex-auto'>
							{
								props.form !== undefined ? props.form : <></>
								// <Form
...
export const BaseModal1 = (props) => {
	let keyInputFields =
		props.inputFields !== undefined
			? Object.keys(props.inputFields).filter(function (element) {
					return !element.match('id') && element !== 'action' && element !== 'html';
			  })
			: '';
	return (
		...
		<div>
			...
			<div className='fixed inset-0 z-20 overflow-y-auto'>
				<div className='flex items-center justify-center px-2 py-5 text-center sm:block'>
					...
					<div
						className='relative inline-block w-full p-5 py-8 sm:p-8 sm:pt-10 text-left align-middle
                     transition-all transform bg-white dark:bg-black rounded-md max-w-xl'
					>
						<div className='border-b border-solid rounded-t pb-2'>
							<h3 className='uppercase text-3xl font-semibold'>{props.title}</h3>
						</div>
						<div className={'py-2'} />
						...
						{props.button !== undefined ? (
							...
							<div className='flex items-center justify-end mt-3 pt-3 border-t border-solid border-slate-200 rounded-b'>
								<button
