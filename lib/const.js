...
export const clientUserMenu = [
    {"link": "/client/profile", "path": "/client/profile", "name": "Profile", "icon": "fas fa-user-group fa-solid fa-1x fa-fw"},
    {"link": "/client/event", "path": "/client/event", "name": "Event", "icon": "fas fa-calendar fa-solid fa-1x fa-fw"},
    {"link": "/client/guest", "path": "/client/guest", "name": "Guest", "icon": "fas fa-rectangle-list fa-solid fa-1x fa-fw"},
    {"link": "/client/gallery", "path": "/client/gallery", "name": "Gallery", "icon": "fas fa-film fa-solid fa-1x fa-fw"},
    {"link": "/client/story", "path": "/client/story", "name": "Story", "icon": "fas fa-pen fa-solid fa-1x fa-fw"},
    {"link": "/client/quote", "path": "/client/quote", "name": "Quote", "icon": "fas fa-message fa-solid fa-1x fa-fw"},
    {"link": "/client/theme", "path": "/client/theme", "name": "Theme", "icon": "fas fa-palette fa-solid fa-1x fa-fw"},
    {"link": "/client/gift", "path": "/client/gift", "name": "Gift", "icon": "fas fa-gift fa-solid fa-1x fa-fw"},
    {"link": "/client/upgrade", "path": "/client/upgrade", "name": "Upgrade", "icon": "fas fa-star fa-solid fa-1x fa-fw"},
    {"link": "/client/setting", "path": "/client/setting", "name": "Setting", "icon": "fas fa-screwdriver-wrench fa-solid fa-1x fa-fw"},
]
